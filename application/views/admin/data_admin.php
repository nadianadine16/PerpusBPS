<div id="wrapper">
  ...
  <div class="card-body">
    <a href="<?= base_url()?>/admin/tambah_data_admin" class="btn btn-primary btn-icon-split">
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <?php $no=1; foreach($admin as $a):?>
          ...
          <td><?=$no++?></td>
                  ...
                  <td>
                  <a href="<?= base_url();?>admin/edit_data_supervisor/<?=$a['id_user'];?>" class="btn btn-success"><i class="fas fa-edit fa-xs" aria-hidden="true"></i></a>
                  <a href="<?=base_url();?>admin/hapus_data_supervisor/<?=$a['id_user'];?>" class="btn btn-danger"><i class="fa fa-trash fa-xs" aria-hidden="true"></i></a></td>
          </tr>
          <?php endforeach;?>          
        </tbody>
      </table>
