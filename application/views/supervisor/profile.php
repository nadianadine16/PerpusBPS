<div id="wrapper">
    ...
    <div id="overlay">
      ...
      <ul class="text"><?= $this->session->userdata('user');?></ul>
      <div class="text1"><?= $this->session->userdata('nip');?></div>
    ...
    <div class="panel-heading " role="tab" id="headingOne">
      <h4 class="panel-title ">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="" aria-controls="collapseOne">
          <div class="title  btn btn-danger btn-outline btn-lg">NAMA PENGGUNA</div>
        </a>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
      <center style="color: black"><?= $this->session->userdata('nama');?></center>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingTwo">
      <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          <div class="title btn btn-danger btn-outline btn-lg">JENIS KELAMIN</div>
        </a>
      </h4>
    </div>
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
      <center style="color: black"><?= $this->session->userdata('jenis_kelamin');?></center>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
      <div class="panel-body">
      <center style="color: black"><?= $this->session->userdata('telepon');?></center>
      </div>
    </div>
  </div>
</div>
